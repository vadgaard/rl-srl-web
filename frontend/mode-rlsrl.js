define("ace/mode/rlsrl_highlight_rules", function(require, exports, module) {
    "use strict";
    ...
    var RLSRLHighlightRules = function(textClass) {
        this.$rules = {
            "start" : [
                {
                    token : "comment",
    ...
    oop.inherits(RLSRLHighlightRules, TextHighlightRules);

    exports.RLSRLHighlightRules = RLSRLHighlightRules;
});

define('ace/mode/rlsrl', function(require, exports, module) {

    var oop = require("ace/lib/oop");
    var TextMode = require("ace/mode/text").Mode;
    var Tokenizer = require("ace/tokenizer").Tokenizer;
    var RLSRLHighlightRules = require("ace/mode/rlsrl_highlight_rules").RLSRLHighlightRules;

    var Mode = function() {
        this.$tokenizer = new Tokenizer(new RLSRLHighlightRules().getRules());
    };
